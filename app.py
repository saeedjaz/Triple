...
# مع استخدام إغلاق الأسبوع الأخير المغلق كسعرٍ افتراضي،# app.py — جدول الأهداف الأسبوعية فقط (كامل)
# =========================================================
# TriplePower — جدول الأهداف (الأسبوعي فقط — سطر واحد لكل رمز)
# يعتمد اختيار "الشمعة البيعية المعتبرة" على كسر الشمعة الشرائية
# (بنفسها أو لاحقًا) وفق شرط 55% — أسبوعي.
...
with st.sidebar:
    ...
    allow_intraday_daily=st.checkbox("👁️ عرض السعر اليومي الحالي بدل إغلاق الأسبوع (اختياري)", value=False,
